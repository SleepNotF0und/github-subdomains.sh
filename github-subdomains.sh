...
# GitHub subdomain finder with list, output, and verbose support

# Usage:

#   Single domain: ./github-subdomains.sh -d domain.com GITHUB_TOKEN [-o output.txt] [-v]

#   Domain list:   ./github-subdomains.sh -l anylist.txt GITHUB_TOKEN [-o output.txt] [-v]
